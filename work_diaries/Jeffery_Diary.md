...
## Week 10
We worked on finalising our demo, our project, and ensuring our software quality was up to standards. I set up a final test run on 17/11 to ensure that everyone knew which functionalities they would be presenting and ensuring that the order was as logical as possible. We made sure that the backend worked fine as some user accounts had illegal items such as null products which could bug the website out. I finished the implementation challenges for swipe survey, uploading an image, and the recommendation system. I completed the Readme file.
